...
Select a theme with SUPER + CTRL + T (custom Hyprland key binding) to execute the themeswitcher.sh script. The script will open rofi to show the themes in the folder ~/kiro-dots/waybar/themes/
...
Please check the configurations of the folders in ~/kiro-dots/waybar/themes/
